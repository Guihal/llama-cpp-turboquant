...
static void ggml_vec_dot_tq4_1s_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_tq2_1s_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQ2_1S] = {
        .from_float               = (ggml_from_float_t) quantize_row_tq2_1s_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_tq2_1s_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
};
...
// TQ2_1S vec_dot: dequantize tq2_1s block to f32, then dot with q8_0.
// TODO: optimize with SIMD intrinsics
static void ggml_vec_dot_tq2_1s_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
    ...
    float * tmp = (float *)malloc(n * sizeof(float));
    GGML_ASSERT(tmp != NULL);
    ggml_get_type_traits(GGML_TYPE_TQ2_1S)->to_float(vx, tmp, n);
