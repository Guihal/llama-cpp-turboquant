...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQ2_1S] = {
        .type_name                = "tq2_1s",
        .blck_size                = QK_TQ2_1S,
        .type_size                = sizeof(block_tq2_1s),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tq2_1s,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tq2_1s_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_TQ2_1S:  result = quantize_tq2_1s(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_F16:
            {
